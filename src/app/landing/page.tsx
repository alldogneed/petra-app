                  ...
                  {[
                    {
                      ...
                      text: "פטרה נבנתה מתוך הבנה של מה קורה כשיש לך רצועה ביד אחת וטלפון ביד שנייה. המערכת חושבת כמו איש מקצוע, לא כמו מתכנת.",
                    },
                    {
                      icon: <Users className="w-5 h-5 text-brand-500 shrink-0 mt-0.5" />,
                      text: "המערכת משתפרת כל יום. מאלפים, גרומרים ומנהלי פנסיונים יושבים פיזית עם צוות הפיתוח שלנו כדי לדייק כל כפתור.",
                    },
                    {
                      icon: <MessageCircle className="w-5 h-5 text-brand-500 shrink-0 mt-0.5" />,
                      text: "אנחנו מבינים את הלחץ של פנסיון בשיא העונה, ואת המחיר של תור שמתבטל. בנינו את הפתרון שאנחנו חיפשנו לעצמנו.",
                    },
                  ].map(({ icon, text }, i) => (
