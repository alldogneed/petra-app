...
const FAQ = [
  {
    ...
    a: "יש מסלול חינמי לצמיתות ללא אשראי — ניתן להתחיל תיכף עם עד 50 לקוחות. למסלולים המשולמים מציעים 14 ימי ניסיון מלאים ללא חיוב: מזינים כרטיס לאימות בלבד, לא חיוב מיידי. אם מבטלים תוך 14 הימים — לא משלמים כלום.",
  },
  {
    q: "מה ניתן לנהל עם פטרה?",
    a: "פטרה היא מערכת ERP שלמה לעסקי חיות מחמד: לקוחות וחיות מחמד, יומן תורים, קביעה אונליין ללקוחות, ניהול פנסיון וחדרים, תהליכי אילוף ותוכניות אישיות, קבוצות וסדנאות, תשלומים ובקשות תשלום, CRM ולידים, ניהול משימות, תזכורות WhatsApp אוטומטיות, ואנליטיקס מלא. הכל במקום אחד.",
  },
  {
    q: "האם פטרה עובדת בנייד?",
    a: "כן — פטרה מותאמת לנייד ועובדת בדפדפן מכל מכשיר. בנוסף, ניתן להוסיף אותה למסך הבית כאפליקציה (PWA) לגישה מהירה בדיוק כמו אפליקציה רגילה, ללא הורדה מהחנות.",
  },
  {
  ...
  },
  {
    ...
    a: "כן — מסלול Basic ומעלה כולל סנכרון דו-כיווני עם Google Calendar. כל תור שנוצר בפטרה מופיע ביומן גוגל שלך אוטומטית, וניתן לראות את כל הפגישות בממשק אחד.",
  },
  {
    q: "איך עובדים התשלומים?",
    a: "כן — מסלול Basic ומעלה כולל שליחת בקשת תשלום בוואטסאפ עם לינק ישיר. במסלול Pro ניתן ליצור הזמנות מלאות ולייצא את כל הנתונים הפיננסיים לאקסל.",
  },
  {
    q: "האם יש ניהול צוות?",
