...
const FAQ = [
  ...
  },
  {
    ...
    a: "פטרה היא מערכת ERP שלמה לעסקי חיות מחמד: לקוחות וחיות מחמד, יומן תורים, קביעה אונליין ללקוחות, ניהול פנסיון וחדרים, תהליכי אילוף ותוכניות אישיות, קבוצות וסדנאות, תשלומים וחשבוניות, CRM ולידים, ניהול משימות, תזכורות WhatsApp אוטומטיות, ואנליטיקס מלא. הכל במקום אחד.",
  },
  {
