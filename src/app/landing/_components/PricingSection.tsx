...
const FAQ = [
  {
    ...
    a: "פטרה בנויה במיוחד לעסקי חיות מחמד ומכסה: לקוחות וחיות מחמד, יומן תורים, תזכורות WhatsApp אוטומטיות, קביעת תורים אונליין, ניהול פנסיון וחדרים, תהליכי אילוף, קבוצות וסדנאות, בקשות תשלום, CRM ולידים, ניהול משימות, אנליטיקס ועוזר AI — הכל במקום אחד.",
  },
  {
    q: "מה ההבדל בין Basic ל-Pro?",
    a: "Basic מיועד לגרומרים ומאלפים עצמאיים — משתמש יחיד עם יומן, תזכורות WhatsApp אוטומטיות, הזמנות אונליין, בקשות תשלום, טפסי קליטה ותיק עבודות לפני/אחרי. Pro מיועד לפנסיונים ומרכזי אילוף — מוסיף עוזר AI, ניהול פנסיון וחדרים, ניהול צוות עם הרשאות, סדנאות וקבוצות, אוטומציות WhatsApp מתקדמות והתראה על כל ליד חדש.",
  },
  {
