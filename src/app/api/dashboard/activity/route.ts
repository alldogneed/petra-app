...
const ACTION_LABELS: Record<string, string> = {
  ...
  COMPLETE_APPOINTMENT: "השלמת תור",
  ...
  CLOSE_LEAD_WON: "סגירת ליד — זכייה",
  CLOSE_LEAD_LOST: "סגירת ליד — הפסד",
  ...
  CREATE_BOARDING_STAY: "יצירת שהייה בפנסיון",
  CHECK_IN: "צ׳ק-אין לפנסיון",
  CHECKIN_BOARDING: "צ׳ק-אין לפנסיון",
  CHECK_OUT: "צ׳ק-אאוט מפנסיון",
  CHECKOUT_BOARDING: "צ׳ק-אאוט מפנסיון",
  DELETE_BOARDING: "מחיקת שהייה בפנסיון",
  CREATE_MESSAGE_TEMPLATE: "יצירת תבנית הודעה",
