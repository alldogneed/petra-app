...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      "2.5 Google Calendar: כאשר אתה מחבר את Google Calendar, אנחנו קוראים וכותבים אירועים ביומן שלך בלבד לצורך סנכרון פגישות.",
      "2.6 נתוני שימוש: לוגים טכניים, כתובת IP, סוג דפדפן – לצורך אבטחה ושיפור המערכת.",
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      "5.1 ספקי שירות: שיתוף מוגבל עם ספקים כגון שירותי דוא\"ל (Resend), SMS ואחסון – רק למידע הנדרש לביצוע השירות.",
      "5.2 Google: ניגשים ל-Google APIs לפי הרשאה שנתת. Google כפופה למדיניות הפרטיות שלה.",
      "5.3 דרישה חוקית: נחשוף מידע אם נדרש על פי חוק ישראלי.",
      "5.4 העברת עסק: במקרה של מכירה או מיזוג, המידע עשוי לעבור לחברה הרוכשת תחת אותם תנאים.",
    ],
  },
  {
    title: "6. אחסון ואבטחת מידע",
    items: [
      "המידע מאוחסן בשרתי ענן מאובטחים (Neon/PostgreSQL) עם הצפנה בסטנדרטים מקובלים.",
