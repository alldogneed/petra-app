...
export const DASHBOARD_SCENES = [
  {
    id: "dashboard-intro",
    text: "ברוכים הבאים לדשבורד של פטרה — מרכז הניהול של העסק שלכם. כאן תראו הכנסות, תורים, לקוחות, ותשלומים ממתינים — הכל במבט אחד.",
  ...
  {
    id: "dashboard-outro",
    text: "הדשבורד של פטרה — כל מה שצריך לנהל את העסק, במקום אחד. נסו עכשיו ותראו את ההבדל.",
