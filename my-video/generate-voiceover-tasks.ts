...
const HEBREW_PREFIX =
  "דבר בעברית ישראלית טבעית ורהוטה. קצב דיבור רגיל לחלוטין — לא מהיר ולא איטי, כמו שיחה יומיומית מקצועית. הגייה ברורה, ניקוד נכון, ללא הפסקות מיותרות.\n\nשים לב: המילה 'משימה' מבוטאת mi-SHEE-ma (מי-שי-מה), הדגש על ההברה האמצעית. 'משימות' = mi-shee-MOT. 'מערכת משימות' = ma-a-RE-khet mi-shee-MOT. הטקסט:\n\n";
