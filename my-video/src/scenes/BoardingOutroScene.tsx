...
const BENEFITS = [
  { text: "מפת חדרים — תמונה מיידית" },
  { text: "שיבוץ אוטומטי מהזמנה" },
  { text: "לוח טיפול יומי לצוות" },
  { text: "ניהול חצרות בגרור ושחרר" },
];

export const BoardingOutroScene: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Logo */}
      <div style={{ transform: `scale(${logoScale})`, opacity: logoOpacity, marginBottom: 32 }}>
      ...
      <div
        style={{
          ...
          cursor: "pointer", display: "flex", alignItems: "center", gap: 12, direction: "rtl",
        }}
      >
        <span style={{ color: "white", fontSize: 19, fontWeight: 800 }}>
          התחילו לנהל את הפנסיון שלכם עכשיו
        </span>
