...
const TABS = [
  { label: "מפת חדרים", sub: "תצוגה ויזואלית", delay: 18 },
  { label: "לוח טיפול יומי", sub: "האכלות, תרופות", delay: 30 },
  { label: "ניהול חצרות", sub: "גרור ושחרר", delay: 42 },
  { label: "שיבוץ אוטומטי", sub: "מהזמנה לפנסיון", delay: 54 },
];

export const BoardingIntroScene: React.FC = () => {
