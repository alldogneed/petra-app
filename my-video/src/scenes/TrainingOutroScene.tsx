...
const BENEFITS = [
  { icon: "🐾", text: "כל כלב באימון — במקום אחד" },
  { icon: "📋", text: "רישום מפגשים וסיכומים" },
  { icon: "🎯", text: "יעדים ושיעורי בית" },
  { icon: "💬", text: "דוח התקדמות בוואטסאפ" },
];

export const TrainingOutroScene: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <p style={{
        ...
        כל כלב, כל מפגש, כל יעד — בשליטה מלאה
      </p>
