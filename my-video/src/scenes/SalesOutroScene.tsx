...
const BENEFITS = [
  { icon: "📊", text: "כל הלידים במקום אחד" },
  { icon: "🔄", text: "שלבים מותאמים אישית" },
  { icon: "💬", text: "וואטסאפ בלחיצה" },
  { icon: "📅", text: "מעקב ופולואפ" },
];

export const SalesOutroScene: React.FC = () => {
  ...
  // Title — matches voiceover: "מערכת המכירות של פטרה — הדרך החכמה לגדול"
  ...
  // CTA — matches voiceover: "פתחו את הלידים עכשיו ותראו את ההבדל"
  ...
  return (
    <AbsoluteFill
      style={{
        opacity,
        background: `radial-gradient(ellipse at 50% 40%, rgba(234,88,12,${
          0.08 + pulse * 0.04
        }) 0%, transparent 55%), linear-gradient(145deg, #0f172a 0%, #1e293b 100%)`,
        display: "flex",
    ...
    >
      ...
      {/* Logo — icon above, wordmark below */}
      <div
        style={{
      ...
      {/* CTA — arrow on the left (RTL "forward"), matches voiceover */}
      <div
        style={{
      ...
      >
        <span style={{ color: "white", fontSize: 19, fontWeight: 800 }}>
          פתחו את הלידים עכשיו ותראו את ההבדל
        </span>
