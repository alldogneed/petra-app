...
const BENEFITS = [
  { text: "כל הלקוחות במקום אחד" },
  { text: "כרטיס חיה מלא" },
  { text: "היסטוריה אוטומטית" },
  { text: "פעולות בלחיצה" },
];

export const CustomersOutroScene: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ color: "rgba(255,255,255,0.9)", fontSize: 28, fontWeight: 700, letterSpacing: 2 }}>PETRA</span>
      </div>
      ...
      >
        כל לקוח, כל חיה, כל פרט — במקום אחד
      </p>
      ...
      >
        <span style={{ color: "white", fontSize: 19, fontWeight: 800 }}>
          הקימו את הלקוחות עכשיו ותראו את ההבדל
        </span>
