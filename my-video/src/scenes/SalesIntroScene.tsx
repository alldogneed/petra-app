...
export const SalesIntroScene: React.FC = () => {
  ...
  const subtitleOpacity = interpolate(frame, [48, 62], [0, 1], {
    extrapolateRight: "clamp",
  });
  ...
  return (
    <AbsoluteFill
      style={{
        opacity,
        background:
          "linear-gradient(145deg, #0f172a 0%, #1e293b 60%, #0c1422 100%)",
        display: "flex",
    ...
    >
      ...
      <div
        style={{
          ...
          width: 700,
          height: 500,
          background: `radial-gradient(ellipse, rgba(234,88,12,${
            0.1 + pulse * 0.05
          }) 0%, transparent 65%)`,
          pointerEvents: "none",
        }}
      ...
      >
        ניהול לידים חכם — אף לקוח פוטנציאלי לא יאבד שוב
      </p>
    </AbsoluteFill>
  );
};
