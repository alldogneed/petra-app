...
// Load config using ts-node or compiled output
// We'll use a simple require trick by reading the TS file and extracting the array
const configContent = fs.readFileSync(
  path.join(__dirname, "../voiceover-orders-config.ts"),
  "utf8"
);
